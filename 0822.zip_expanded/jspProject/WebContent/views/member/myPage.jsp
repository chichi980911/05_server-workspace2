	...
	<div class="outer">
        ...
        <form action="<%= contextPath %>/update.me" method="post" id="mypage-form">
            <table>
                ...
                <tr>
                    <td>&nbsp;&nbsp;주소</td>
                    <td><input type="text" name="<%= address %>" value="서울시 강남구 역삼동"></td>
                    <td></td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;관심분야</td>
            ...
            <div align="center">
                <button type="submit" class="btn btn-sm btn-secondary">정보수정버튼</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" align="center">
          <form action="<%= contextPath %>/delete.me" method="post">
              ...
              <b>탈퇴 후 복구가 불가능 합니다. <br> 정말로 탈퇴하시겠습니까? <br></b>
          	  <input type="hidden" name="userId" value="<%= userId %>"> 
          ...
          <!-- 
				...
				성공했을 경우 : 메인페이지 alert(성공적으로 회원탈퇴 되었습니다. 그동안 이용해주셔서 감사합니다.) 
							로그아웃 되어있어야함(세션에 loginMember 라는 키값에 해당하는걸 삭제)
				실패했을 경우 : 마이페이지 alert (회원탈퇴에 실패)
