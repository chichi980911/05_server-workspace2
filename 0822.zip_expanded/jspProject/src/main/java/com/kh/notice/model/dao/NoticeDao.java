...
public class NoticeDao {
	...
	public ArrayList<Notice> selectNoticeList(Connection conn) {
		// select문 => Result 객체 => 여러행 => ArrayList<Notice>객체
	...
	public Notice selectNotice(int noticeNo,Connection conn) {
		// select 문 => ResultSet 객체 => 한행 => Notice 객체
		Notice n = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public int deledeNotice(int noticeNo,Connection conn) {
		int result = 0;
		PreparedStatement pstmt = null;
		
		String sql = prop.getProperty("deledeNotice");
