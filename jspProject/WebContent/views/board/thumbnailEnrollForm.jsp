    ...
    <div class="outer">
        ...
        <form action="<%=contextPath %>/insert.th" id="enroll-form" method="post" enctype="multipart/form-data">
            ...
            function loadImg(inputFile,num){
            	...
            	//선택된 파일이 있다면 inputFile.files[0]에 선택된 파일이 담겨 있다.
            					//inputFile.length 또한 1이 될꺼임
            			...
            			// 해당 파일을 읽어 들이는 순간 해당 이 파링ㄹ만의 고유한 url 부여
            			
            			//파일 읽어들이기가 완료 됐을 때 실행할 함수를 정의해두기
            			reader.onload = function(e){
            				console.log(e)
            				//e.target.result = > 읽어들인 파일의 교유한 url
            				switch(num){
