...
<body>
    ...
    <div class="outer">
        ...
        <table class="detail-area" align="center">
            ...
            <tr>
                <td>내용</td>
                <td colspan="3"><p style="height: 50;">${b.boardContent }</p></td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <div>
                    	...
                    	<c:forEach var="c" items="${list }" begin="1" varStatus="status">
                    	<img src="${list[count] }/${list[0].changeName}"  width="200" height="150">
                    	</c:forEach>
